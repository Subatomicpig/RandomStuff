...
void create_City(struct city*,unsigned int,unsigned int);
void destroy_City(struct city*);
void update_Ammo(struct missile_Silo*);
void create_Silo(struct missile_Silo*);
void destroy_Silo(struct missile_Silo*);
void missile_Fired(unsigned int, unsigned int, struct missile*);
...
void reset_explosion(struct explosion *exp);
void make_explosion(struct explosion *exp, unsigned int, unsigned int);
...
void create_Silo(struct missile_Silo *silo)
{
	(*silo).health = 1;
	(*silo).ammo = 1000;
	(*silo).pX = 288;
