...
*/
void render_main(long int *base, struct world game, int mouseX, int mouseY)
{
	clear_screen(base);
	render_city(base,game.cities[0]);
	render_city(base,game.cities[1]);
	render_city(base,game.cities[2]);
	render_city(base,game.cities[3]);
	render_city(base,game.cities[4]);
	render_city(base,game.cities[5]);
	render_silo(base,game.mainSilo);
	render_ground(base);
	render_missile(base,game.enemyMissiles);
	render_missile(base,game.friendlyMissiles);
	render_explosion(base,game.explosions);
